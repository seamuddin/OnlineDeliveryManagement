    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - Online Food Ordering System <a href="https://zebaafiashama.xyz/" target="_blank">Zeba Afia Shama</a></div></div>
        </footer>
